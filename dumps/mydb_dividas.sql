...
CREATE TABLE `dividas` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_dividas_emprestimos1_idx` (`emprestimos_id`),
  CONSTRAINT `fk_dividas_emprestimos1` FOREIGN KEY (`emprestimos_id`) REFERENCES `emprestimos` (`id`)
...
-- Dump completed on 2022-04-16 21:48:20
