...
public class BibliotecaRest extends UtilRest {
	...
	public Response addServico(String servicoParam) {
		try {
			...
			boolean retorno = jdbcBiblioteca.inserir(servico);
			conec.fecharConexao();

			if (retorno) {
				return this.buildResponse("Serviço cadastrado com sucesso.");
			} else {
				return this
						.buildErrorResponse("Não foi possível cadastrar o serviço.");
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	@POST
	@Path("/buscarServicosPorNome/{servico}")
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public Response buscarServicosPorNome(@PathParam("servico") String servico) {
		try {
			...
			Connection conexao = conec.abrirConexao();
			JDBCBibliotecaDAO jdbcBiblioteca = new JDBCBibliotecaDAO(conexao);
			servicos = jdbcBiblioteca.buscarPorNome(servico);
			conec.fecharConexao();
	...
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public Response buscarServicosPorData(@PathParam("valorBusca") String valorBusca, @PathParam("valorBusca2") String valorBusca2) {
		...
		try {
			...
			Connection conexao = conec.abrirConexao();
			JDBCBibliotecaDAO jdbcBiblioteca = new JDBCBibliotecaDAO(conexao);
			servicos = jdbcBiblioteca.buscarPorData(valorBusca, valorBusca2);
			conec.fecharConexao();
	...
	@POST
	@Path("/buscarServicosPorDataAte/{valorBuscaDe}/{valorBuscaAte}/{metodo}")	
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public Response buscarServicosPorDataAte(@PathParam("valorBuscaDe") String valorBuscaDe, @PathParam("valorBuscaAte") String valorBuscaAte, @PathParam("metodo") int metodo) {
		try {
			...
			Connection conexao = conec.abrirConexao();
			JDBCBibliotecaDAO jdbcBiblioteca = new JDBCBibliotecaDAO(conexao);
			servicos = jdbcBiblioteca.buscarPorDataAte(valorBuscaDe, valorBuscaAte, metodo);
			conec.fecharConexao();
	...
	@POST
	@Path("/buscarServicosPorDataHj/{valorBusca}/{metodo}")	
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public Response buscarServicosPorDataHj(@PathParam("valorBusca") String valorBusca, @PathParam("metodo") String metodo) {
		try {
			
			
		
			List<Servico> servicos = new ArrayList<Servico>();
System.out.println(valorBusca + metodo);
			Conexao conec = new Conexao();
			Connection conexao = conec.abrirConexao();
			JDBCBibliotecaDAO jdbcBiblioteca = new JDBCBibliotecaDAO(conexao);
			servicos = jdbcBiblioteca.buscarPorDataHj(valorBusca, metodo);
			conec.fecharConexao();
	...
	public Response deletarServico(@PathParam("id") int id) {
		try {
			...
			Connection conexao = conec.abrirConexao();
			JDBCBibliotecaDAO jdbcBiblioteca = new JDBCBibliotecaDAO(conexao);
			boolean retorno = jdbcBiblioteca.deletarServico(id);
			conec.fecharConexao();
			if (retorno) {
				return this.buildResponse("Serviço deletado com sucesso!");
			} else {
				
				return this.buildErrorResponse("Não foi possível deletar.");
			}
	...
	public Response buscarServicoPeloId(@PathParam("id") int id) {
		try {
			...
			JDBCBibliotecaDAO jdbcBiblioteca = new JDBCBibliotecaDAO(conexao);
			Servico servico = jdbcBiblioteca.buscarPorId(id);
			conec.fecharConexao();
	...
	public Response editarServico(String servicoParam) {
		try {
			...
			Connection conexao = conec.abrirConexao();
			JDBCBibliotecaDAO jdbcBiblioteca = new JDBCBibliotecaDAO(conexao);
			boolean retorno = jdbcBiblioteca.atualizar(servico);
			conec.fecharConexao();

			if (retorno) {
				return this.buildResponse("Serviço editado com sucesso!");
			} else {
				return this
						.buildErrorResponse("Não foi possível editar o serviço.");
			}
		} catch (Exception e) {
			e.printStackTrace();
			return this.buildErrorResponse(e.getMessage());
	...
	@GET
	@Path("/coletarServicos/")
	@Produces(MediaType.APPLICATION_JSON)
	public Response coletarServicos() {
		try {
			...
			Connection conexao = conec.abrirConexao();
			JDBCBibliotecaDAO jdbcBiblioteca = new JDBCBibliotecaDAO(conexao);
			servico = jdbcBiblioteca.coletarServico();
			conec.fecharConexao();
