				...
				function() {	
					SENAI.biblioteca.sincLogin = function() {
						...
						var senhaCript = MD5(senha);
							  ...
							  cfg = {
										type : "POST",
										url : "rest/bibliotecaRest/buscarAdminsPorNome/"
												+ null,
										success : function(listaDeAdmins) {
											
											for (var i = 0; i < listaDeAdmins.length; i++) {
												if(listaDeAdmins[i].login == login){
													if(listaDeAdmins[i].senha == senhaCript){
														flag = 1;
														
														cfh = {
																type : "POST",
																url : "rest/bibliotecaRest/logarAdmin/"
																		+ listaDeAdmins[i].id,
																success : function(usuario) {
																	
																	
																	if(window.location != "resources/admin/index.jsp"){
