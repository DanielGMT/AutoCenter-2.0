...
<div id="cadastrarAutor">
	<p>
		<button class="btn btn-primary" onclick="SENAI.biblioteca.descerPag()" id="downButton" type="button"
			...
			Cadastrar Novo Serviço <span class="caret"></span>
		</button>
	</p>
</div>
...
<div class="collapse" id="collapseExample">
	...
	<div style="width: 50%; float: left;">
		...
		class="form-control" placeholder="Não obrigatório" autocomplete="off" type="text" id="inputplaca">
	</div>		
	<div style="width: 50%; float: right;">
...
<div class="table-wrapper">
	<div class="col-md-12">
		<h2 class="pt-3 pb-4 text-center font-bold font-up deep-purple-text">Serviços
			Registrados</h2>
		<div id="teste">
		...
		<select class="form-control" onChange="SENAI.biblioteca.verificaResult(this)"><option value='0'>Total</option><option value='1'>Total de Hoje</option><option value='3'>Hoje em Dinheiro</option><option value='4'>Hoje em Débito</option><option value='5'>Hoje em Crédito</option><option value='6'>Hoje em Pix</option><option value='2'>Últimos 30 dias</option><option value='7'>Últimos 30 dias em dinheiro</option><option value='8'>Últimos 30 dias em débito</option><option value='9'>Últimos 30 dias em crédito</option><option value='10'>Últimos 30 dias em pix</option></select>
			<input type="hidden" class="form-control" onChange="SENAI.biblioteca.buscarServico()" id="searchBar" />
		</div>
		<div><label for="totalglobal">Total Líquido: <br></label><input id="totalglobal" disabled name="totalglobal" type="text"></div>
	</div>
...
<div id="editarServico" style="display: none">
	<label>Serviço:</label> <input disabled id="servicoEdit" class="form-control" name="servico" type="text">
	...
	<label>Data de serviço:</label> <input disabled id="dataEdit" class="form-control" name="data" type="text">
